...
class Webinse_DailyDeals_Block_Adminhtml_Category_Edit_Form extends Mage_Adminhtml_Block_Widget_Form{
    ...
    protected function _prepareForm() {
        ...
        $fieldset->addField('qty_deal_product', 'text', array(
        ...
        $fieldset->addField('deal_update_days', 'multiselect', array(
        ...
        $fieldset->addField('deal_qty_product_percent', 'text', array(
            'label' => $helper->__('Qty Deal Product (depends on availability in stock)'),
            'name' => 'deal_qty_product_percent',
            'required'=>true,
        ));
        $fieldset->addField('deal_discount_percent', 'text', array(
